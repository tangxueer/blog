        ...
        <div class="col-md-12">
          <p>
            <div class="btn-group">
                ...
                <button type="button" class="btn btn-success active">管理用户</button>
            </div>
          </p>
        </div>
      </div>
...
<div class="container-fluid">
  ...
  <table id="customers" class="table table-bordered table-hover">
      	<tr class="active">
      		...
      		<th class="col-md-1">用户密码</th>
      		<th class="col-md-1">用户注册时间</th>
      		<th class="col-md-1">用户昵称</th>
      		<th class="col-md-1">删除用户</th>
      	</tr>

      	<?php for($id=0;$id<$allid;$id++){?>
      	<tr class="alt">
      		<td class="col-md-1"><?php echo $user[$id]['uid'];?></td>	
      		<td class="col-md-1"><?php echo $user[$id]['uname'];?></td>
      		<td class="col-md-1"><?php echo $user[$id]['upass'];?></td>		
      		<td class="col-md-1"><?php echo $user[$id]['udate'];?></td>
      		<td class="col-md-1"><?php echo $user[$id]['nickname'];?></td>
      		<td class="col-md-1"><form action="<?php echo "/codeigniter/index.php/blog_b/delete_user/".$user[$id]['uid'];?>" method="post">
      		<input class="btn btn-danger" data-placement="top" data-toggle="tooltip" title="确定删除这位用户?" name="sub_del" type="submit" value="删除" /></form></td>
      	</tr>	
      	<?php }?>	
  </table>
